...
public class Camera {
  ...
  public static final Vec3 DEFAULT_POSITION = new Vec3(0,10f,25f);
  public static final Vec3 DEFAULT_POSITION_2 = new Vec3(25f,10f,0);
  ...
  private void setupCamera(Vec3 position, Vec3 target, Vec3 up) {
    ...
    if (position.equals(new Vec3(0,0,0))) {
      position = new Vec3(0.1f, 0.1f, 0.1f);  // Slightly offset to avoid clipping
    }
